...
LANGUAGE SQL
AS $$
    SELECT LPAD(nextval(seq_name)::TEXT, 3, '0');
$$;
...
BEGIN
    EXECUTE format(
        'SELECT COALESCE(MAX(CASE WHEN %1$I ~ ''(\d+)$'' THEN substring(%1$I from ''(\d+)$'')::BIGINT END), 0) FROM %2$I',
        column_name,
        table_name
    )
    INTO max_value;
...
CREATE SEQUENCE main_category_display_id_seq START WITH 1;
CREATE SEQUENCE category_display_id_seq START WITH 1;
CREATE SEQUENCE test_type_display_id_seq START WITH 1;
CREATE SEQUENCE template_display_id_seq START WITH 1;
CREATE SEQUENCE template_component_display_id_seq START WITH 1;
CREATE SEQUENCE template_component_test_display_id_seq START WITH 1;
CREATE SEQUENCE asset_display_id_seq START WITH 1;
CREATE SEQUENCE component_display_id_seq START WITH 1;
CREATE SEQUENCE certificate_display_id_seq START WITH 1;
CREATE SEQUENCE scheduled_task_display_id_seq START WITH 1;
