DROP INDEX IF EXISTS idx_certificate_competency_categories_category_id;
DROP TABLE IF EXISTS certificate_competency_categories;

DROP INDEX IF EXISTS idx_template_component_test_competency_categories_category_id;
DROP TABLE IF EXISTS template_component_test_competency_categories;
