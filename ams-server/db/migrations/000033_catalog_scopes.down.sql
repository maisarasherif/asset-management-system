DROP INDEX IF EXISTS idx_template_components_scope_category_id;
DROP INDEX IF EXISTS idx_components_scope_category_id;

ALTER TABLE template_components
    DROP CONSTRAINT IF EXISTS template_components_scope_category_id_fkey,
    DROP COLUMN IF EXISTS scope_category_id;

ALTER TABLE components
    DROP CONSTRAINT IF EXISTS components_kind_assignment_check;

ALTER TABLE components
    DROP CONSTRAINT IF EXISTS components_scope_category_id_fkey,
    DROP COLUMN IF EXISTS scope_category_id;
...
DROP INDEX IF EXISTS idx_catalog_scope_categories_category_id;
DROP INDEX IF EXISTS idx_catalog_scope_categories_scope_id;
DROP INDEX IF EXISTS idx_catalog_scope_main_categories_scope_id;

DROP TABLE IF EXISTS catalog_scope_categories;
DROP TABLE IF EXISTS catalog_scope_main_categories;

DROP INDEX IF EXISTS catalog_scopes_scope_name_unique;
DROP TABLE IF EXISTS catalog_scopes;

DROP SEQUENCE IF EXISTS catalog_scope_category_display_id_seq;
DROP SEQUENCE IF EXISTS catalog_scope_main_category_display_id_seq;
DROP SEQUENCE IF EXISTS catalog_scope_display_id_seq;
