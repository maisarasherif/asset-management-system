DROP INDEX IF EXISTS categories_null_main_category_sort_order_unique;
DROP INDEX IF EXISTS categories_main_category_sort_order_unique;

ALTER TABLE main_categories
    DROP CONSTRAINT IF EXISTS main_categories_sort_order_unique;

ALTER TABLE categories DROP COLUMN IF EXISTS sort_order;
ALTER TABLE main_categories DROP COLUMN IF EXISTS sort_order;
